 ...
 <div class="container">
   ...
   <div class="row justify-content-center">
     <h3>Edit User</h3>
       ...
       <form method="post" action="<?php echo site_url('users/update');?>/<?php echo $post->employeecode; ?>">
    
         <div class="form-group">
           <label >First Name</label>
           <input type="text" class="form-control" name="fname" value="<?php echo $post->FirstName; ?>">
         </div>
         <div class="form-group">
           <label >Last Name</label>
           <input type="text" class="form-control" name="lname" value="<?php echo $post->LastName; ?>">
         </div>
         <div class="form-group">
           <label >Date of Birth</label>
           <input type="date" class="form-control" name="dob" value="<?php echo $post->dateofbirth;?>">
         </div>
         <div class="form-group">
           <label >Email Address</label>
           <input type="email" class="form-control" name="email" onblur="checkEmail(this.value)" value="<?php  echo $post->email; ?>">
         </div>
         <div class="form-group">
         ...
         <div class="form-group">
           ...
           <input type="text" class="form-control" id="phonenumber" name="phone" value="<?php echo $post->phone; ?>">
         </div>
         <div class="form-group">
           <label for="exampleInputPassword1">Position</label>
           <input type="text" class="form-control" id="exampleInputPassword1" name="position" value="<?php echo $post->position; ?>">
         </div>
         <div class="form-group">
           <label >Role</label>
           <input type="text" class="form-control" name="role" value="<?php echo $post->role; ?>">
         </div>
         <button type="submit" class="btn btn-primary" onclick="windowConfirm()">Submit</button>
       </form>
   </div>
 </div>
 <?php

 ...
 <div class="container">
                    ...
                    <?php echo form_open('users/add')?>
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="exampleInputEmail1" name="id" aria-describedby="emailHelp" placeholder="Employee ID">
                            </div>
                            <div class="form-group">
                                <label >First Name</label>
                                <input type="text" class="form-control" id="exampleInputEmail1" name="fname" aria-describedby="emailHelp" placeholder="First Name">
                            </div>
                            <div class="form-group">
                                <label>Last Name</label>
                                <input type="text" class="form-control" id="exampleInputEmail1" name="lname" aria-describedby="emailHelp" placeholder="Last Name">
                            </div>
                            <div class="form-group">
                                <label >Date of Birth</label>
                                <input type="date" class="form-control" max="2002-12-31" id="exampleInputEmail1" name="dob" aria-describedby="emailHelp">
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="exampleInputEmail1" name="address" aria-describedby="emailHelp" placeholder="Home Address">
                            </div>
                            <div class="form-group">
                                <label>Phone Number</label>
                                <input type="text" class="form-control" id="phonenumber" name="phone" aria-describedby="emailHelp" placeholder="Phone Number">
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                <label>Role</label>
                                <input type="text" class="form-control" id="exampleInputEmail1" name="role" placeholder="Role">
                            </div>
